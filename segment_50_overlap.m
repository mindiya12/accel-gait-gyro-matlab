% ============================================================
% CREATE 50% OVERLAPPING SEGMENTS
% ============================================================
...
overlap_percent = 50;
overlap_samples = round(window_size * overlap_percent / 100);  % ~78 samples
step_size = window_size - overlap_samples;  % ~77 samples

fprintf('=== CREATING 50%% OVERLAPPING SEGMENTS ===\n');
...
saveFileName = 'segmented_data_overlap50.mat';
